 ...
 * PUBLIC_INTERFACE
 * Signup
 * Signup page for new users in a modern blue-themed card with transitions.
 */
export default function Signup() {
  ...
  return (
    <div className="auth-container theme-user">
      ...
      <div className="auth-card auth-card--large auth-card--taller glass-card card-appear" role="region" aria-label="User signup form">
        <div className="auth-stack">
          <div className="auth-headblock">
            <div className="auth-icon" aria-hidden="true">✨</div>
            <div className="auth-headtext">
              <h2 className="auth-title">Sign up</h2>
              <p className="auth-subtitle">Join to access your analytics dashboard</p>
              <p className="auth-tagline">Create your account</p>
            </div>
          </div>

          {error ? (
            <div className="auth-error" role="alert">{String(error)}</div>
          ) : null}
